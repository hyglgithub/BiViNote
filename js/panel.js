...
直接输出总结，不要输出任何额外说明。`;
  ...
  function bindDocAutoEvents() {
    ...
    function renderPromptSwitcher() {
      ...
      html += `<button class="bn-prompt-add-btn" id="bn-prompt-add-btn" title="提示词管理"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></button>`;
